...
3. Route to the specialist skill as soon as the category is clear:
   - Review comments and requested changes: `../scrap-gh-address-comments/SKILL.md`
   - Failing GitHub Actions checks: `../scrap-gh-fix-ci/SKILL.md`
   - Commit, push, and open PR: `../scrap-yeet/SKILL.md`
   - All publish, review-fix, and CI-fix routes commit using Conventional Commits — the canonical type list and message format live in `../scrap-git-commit/SKILL.md`.
