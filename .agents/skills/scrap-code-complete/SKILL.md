---
name: scrap-code-complete
description: "Code Complete by Steve McConnell rules from mattpocock/agent-rules-books. Use when implementing, changing, reviewing, debugging, refactoring, or tuning production code where construction discipline must reduce defects and keep code easy to inspect."
---

<!-- Source: https://github.com/mattpocock/agent-rules-books/tree/main/code-complete -->
<!-- Upstream commit: a7d7649044505b9c377c8dca28d2d6a543bc7f8c -->
<!-- Installed from: code-complete/code-complete.mini.md -->
