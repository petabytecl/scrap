...
During finding discovery, apply this repository-wide workflow instead of the diff-centered discovery workflow. Use `../../scrap-finding-discovery/SKILL.md` for the candidate output contract and `scan-artifacts.md` for repository-wide artifact paths.
