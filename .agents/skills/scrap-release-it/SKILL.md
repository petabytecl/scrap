---
name: scrap-release-it
description: "Release It! by Michael T. Nygard rules from mattpocock/agent-rules-books. Use for services, APIs, jobs, queues, deployment paths, control tooling, and critical flows that must survive production failures, overload, latency, bad data, hostile traffic, and operational mistakes."
---

<!-- Source: https://github.com/mattpocock/agent-rules-books/tree/main/release-it -->
<!-- Upstream commit: a7d7649044505b9c377c8dca28d2d6a543bc7f8c -->
<!-- Installed from: release-it/release-it.mini.md -->
