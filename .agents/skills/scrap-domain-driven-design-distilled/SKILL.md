---
name: scrap-domain-driven-design-distilled
description: "Domain-Driven Design Distilled by Vaughn Vernon rules from mattpocock/agent-rules-books. Use when business software has enough domain complexity, language ambiguity, strategic differentiation, or integration risk that modeling changes implementation decisions, but the project still needs the smallest effective DDD practice rather than ceremony."
---

<!-- Source: https://github.com/mattpocock/agent-rules-books/tree/main/domain-driven-design-distilled -->
<!-- Upstream commit: a7d7649044505b9c377c8dca28d2d6a543bc7f8c -->
<!-- Installed from: domain-driven-design-distilled/domain-driven-design-distilled.mini.md -->

For deeper source material, use [reference.md](reference.md) only when the mini rules are not enough for a focused audit, design pass, or refactor.
