...
6. Save any PoC files, inputs, or logs under the validation artifacts path from `../security-scan/references/scan-artifacts.md`.
...
- Keep validation artifacts and the final visible report in the validation paths from `../security-scan/references/scan-artifacts.md` so the full scan bundle lives together.
