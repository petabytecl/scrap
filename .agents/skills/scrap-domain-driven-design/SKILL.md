---
name: scrap-domain-driven-design
description: "Domain-Driven Design by Eric Evans rules from mattpocock/agent-rules-books. Use when business complexity, model language, lifecycle rules, or cross-team/system boundaries shape the design more than generic technical organization."
---

<!-- Source: https://github.com/mattpocock/agent-rules-books/tree/main/domain-driven-design -->
<!-- Upstream commit: a7d7649044505b9c377c8dca28d2d6a543bc7f8c -->
<!-- Installed from: domain-driven-design/domain-driven-design.mini.md -->
