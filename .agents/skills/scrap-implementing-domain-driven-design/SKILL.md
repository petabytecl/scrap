---
name: scrap-implementing-domain-driven-design
description: "Implementing Domain-Driven Design by Vaughn Vernon rules from mattpocock/agent-rules-books. Use when DDD implementation choices affect bounded contexts, language, aggregates, repositories, events, application services, package structure, or cross-context integration."
---

<!-- Source: https://github.com/mattpocock/agent-rules-books/tree/main/implementing-domain-driven-design -->
<!-- Upstream commit: a7d7649044505b9c377c8dca28d2d6a543bc7f8c -->
<!-- Installed from: implementing-domain-driven-design/implementing-domain-driven-design.mini.md -->
