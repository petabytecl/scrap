---
name: scrap-clean-architecture
description: "Clean Architecture by Robert C. Martin rules from mattpocock/agent-rules-books. Use when adding, changing, reviewing, or refactoring code whose business rules should survive changes in frameworks, databases, delivery mechanisms, services, devices, vendors, deployment shape, or schedule pressure."
---

<!-- Source: https://github.com/mattpocock/agent-rules-books/tree/main/clean-architecture -->
<!-- Upstream commit: a7d7649044505b9c377c8dca28d2d6a543bc7f8c -->
<!-- Installed from: clean-architecture/clean-architecture.mini.md -->
