...
For the full severity taxonomy with examples of critical, high, and non-qualifying findings, see `../attack-path-analysis/references/severity-policy.md`.
...
- Save a final visible report using the finding discovery report path from `../security-scan/references/scan-artifacts.md`.
