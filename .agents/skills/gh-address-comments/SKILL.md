...
When implementing fixes locally, any commits MUST follow Conventional Commits. The canonical type list and format live in `../git-commit/SKILL.md`. For review-driven changes the typical mapping is:
