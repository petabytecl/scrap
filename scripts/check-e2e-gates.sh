...
RELEASE_EVIDENCE_CONSISTENCY_CHECK=${RELEASE_EVIDENCE_CONSISTENCY_CHECK:-scripts/check-release-evidence-consistency.sh}
[ -x "$RELEASE_EVIDENCE_CONSISTENCY_CHECK" ] || fail "missing executable release evidence consistency validator ${RELEASE_EVIDENCE_CONSISTENCY_CHECK}"
"$RELEASE_EVIDENCE_CONSISTENCY_CHECK"
