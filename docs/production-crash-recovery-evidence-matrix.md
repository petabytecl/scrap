...
| FI-1 | Metadata commit forensics | Single-voter Raft is not claimed as independently tamper-evident against privileged filesystem access; a production profile needs external append-only witness evidence or multi-voter topology evidence before claiming forensic integrity. | ADR 0016 documents the current limitation and compensating controls. | Future external witness or multi-voter production topology evidence | Blocked until target-profile forensic evidence is accepted. |
