...
| Current `v2` push CI | `gh run view 27450472880 --repo petabytecl/scrap --json status,conclusion,url,headSha,jobs` | Success for commit `a2738bb8caf9d5b9853c61c7e8889d8a8e43bba0`; `e2e` job skipped because push events do not request Tier 2 E2E. Run URL: `https://github.com/petabytecl/scrap/actions/runs/27450472880`. |
