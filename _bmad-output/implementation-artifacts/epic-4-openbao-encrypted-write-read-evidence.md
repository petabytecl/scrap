...
| --- | --- | --- | --- |
| Credential pattern scan | PASS | 0 strict shaped-value matches; 154 broad vocabulary matches | Broad matches classified as allowed policy, fixture, test, or artifact vocabulary. |
| Identifier pattern scan | PASS | 0 strict shaped-value matches; 106 broad vocabulary matches | Broad matches classified as allowed policy, fixture, test, or artifact vocabulary. |
