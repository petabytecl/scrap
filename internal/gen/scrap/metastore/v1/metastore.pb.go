...
const (
	...
	MembershipRole_MEMBERSHIP_ROLE_VOTER       MembershipRole = 1
	MembershipRole_MEMBERSHIP_ROLE_LEARNER     MembershipRole = 2
)
...
var (
	MembershipRole_name = map[int32]string{
		...
		1: "MEMBERSHIP_ROLE_VOTER",
		2: "MEMBERSHIP_ROLE_LEARNER",
	}
...
func (MembershipRole) Descriptor() protoreflect.EnumDescriptor {
	return file_scrap_metastore_v1_metastore_proto_enumTypes[2].Descriptor()
}

func (MembershipRole) Type() protoreflect.EnumType {
	return &file_scrap_metastore_v1_metastore_proto_enumTypes[2]
}
...
type DocumentRecord struct {
	...
	TombstonedAt                *timestamppb.Timestamp `protobuf:"bytes,26,opt,name=tombstoned_at,json=tombstonedAt,proto3,oneof" json:"tombstoned_at,omitempty"`
	TombstoneOperationId        *string                `protobuf:"bytes,27,opt,name=tombstone_operation_id,json=tombstoneOperationId,proto3,oneof" json:"tombstone_operation_id,omitempty"`
...
func (x *DocumentRecord) GetTombstonedAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *DocumentRecord) GetTombstoneOperationId() string {
	if x != nil && x.TombstoneOperationId != nil {
		return *x.TombstoneOperationId
	}
	return ""
}
...
func (x *RepairStateRecord) Reset() {
	*x = RepairStateRecord{}
...
func (x *RepairStateRecord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepairStateRecord) ProtoMessage() {}

func (x *RepairStateRecord) ProtoReflect() protoreflect.Message {
	mi := &file_scrap_metastore_v1_metastore_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepairStateRecord.ProtoReflect.Descriptor instead.
func (*RepairStateRecord) Descriptor() ([]byte, []int) {
	return file_scrap_metastore_v1_metastore_proto_rawDescGZIP(), []int{7}
}

func (x *RepairStateRecord) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *RepairStateRecord) GetTransactionId() string {
	if x != nil {
		return x.TransactionId
	}
	return ""
...
func (x *RepairStateRecord) GetDocumentName() string {
	if x != nil {
		return x.DocumentName
	}
	return ""
...
func (x *RepairStateRecord) GetPhysicalRef() string {
	if x != nil {
...
func (x *RepairStateRecord) GetIncidentId() string {
	if x != nil {
		return x.IncidentId
	}
	return ""
...
func (x *RepairStateRecord) GetQuarantined() bool {
	if x != nil {
...
func (x *RepairStateRecord) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *RepairStateRecord) GetSchemaVersion() uint32 {
	if x != nil {
		return x.SchemaVersion
	}
	return 0
...
func (x *RepairStateRecord) GetShardId() string {
	if x != nil {
		return x.ShardId
	}
	return ""
...
func (x *RepairStateRecord) GetCommittedIndex() uint64 {
	if x != nil {
		return x.CommittedIndex
	}
	return 0
...
type MembershipMember struct {
	...
	Role          MembershipRole         `protobuf:"varint,3,opt,name=role,proto3,enum=scrap.metastore.v1.MembershipRole" json:"role,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MembershipMember) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MembershipMember) GetMemberId() string {
	if x != nil {
		return x.MemberId
	}
	return ""
...
func (x *MembershipMember) GetRole() MembershipRole {
	if x != nil {
		return x.Role
	}
...
type MembershipState struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Members       []*MembershipMember    `protobuf:"bytes,1,rep,name=members,proto3" json:"members,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ShardSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ShardSnapshot) GetShardId() string {
	if x != nil {
		return x.ShardId
	}
	return ""
...
func (x *ShardSnapshot) GetLastIndex() uint64 {
	if x != nil {
		return x.LastIndex
	}
	return 0
...
func (x *ShardSnapshot) GetDocuments() []*DocumentRecord {
	if x != nil {
		return x.Documents
	}
	return nil
...
func (x *ShardSnapshot) GetTransactions() []*TransactionRecord {
	if x != nil {
...
func (x *ShardSnapshot) GetUploadIntents() []*UploadIntentRecord {
	if x != nil {
		return x.UploadIntents
	}
	return nil
}

func (x *ShardSnapshot) GetRepairStates() []*RepairStateRecord {
	if x != nil {
		return x.RepairStates
	}
	return nil
}

func (x *ShardSnapshot) GetMembership() *MembershipState {
	if x != nil {
		return x.Membership
	}
	return nil
...
const file_scrap_metastore_v1_metastore_proto_rawDesc = "" +
	"\n" +
	"\"scrap/metastore/v1/metastore.proto\x12\x12scrap.metastore.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcf\v\n" +
	...
	"\fupload_state\x18\x19 \x01(\x0e2\x1f.scrap.metastore.v1.UploadStateR\vuploadState\x12D\n" +
	"\rtombstoned_at\x18\x1a \x01(\v2\x1a.google.protobuf.TimestampH\x03R\ftombstonedAt\x88\x01\x01\x129\n" +
	"\x16tombstone_operation_id\x18\x1b \x01(\tH\x04R\x14tombstoneOperationId\x88\x01\x01\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x0f\n" +
	"\r_content_typeB\x11\n" +
	"\x0f_workflow_stageB\x19\n" +
	"\x17_client_idempotency_keyB\x10\n" +
	"\x0e_tombstoned_atB\x19\n" +
	"\x17_tombstone_operation_id\"\xe6\x03\n" +
	"\bLocation\x12\x19\n" +
	...
	"\v_last_error\"\x88\x03\n" +
	"\x11RepairStateRecord\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12%\n" +
	"\x0etransaction_id\x18\x02 \x01(\tR\rtransactionId\x12#\n" +
	"\rdocument_name\x18\x03 \x01(\tR\fdocumentName\x12!\n" +
	...
	"incidentId\x12 \n" +
	"\vquarantined\x18\x06 \x01(\bR\vquarantined\x129\n" +
	"\n" +
	"updated_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\x12%\n" +
	"\x0eschema_version\x18\x14 \x01(\rR\rschemaVersion\x12\x19\n" +
	"\bshard_id\x18\x15 \x01(\tR\ashardId\x12'\n" +
	...
	"\tdocuments\x18\n" +
	" \x03(\v2\".scrap.metastore.v1.DocumentRecordR\tdocuments\x12I\n" +
	"\ftransactions\x18\v \x03(\v2%.scrap.metastore.v1.TransactionRecordR\ftransactions\x12M\n" +
	"\x0eupload_intents\x18\f \x03(\v2&.scrap.metastore.v1.UploadIntentRecordR\ruploadIntents\x12J\n" +
	...
	"\x13UPLOAD_STATE_FAILED\x10\x04*i\n" +
	"\x0eMembershipRole\x12\x1f\n" +
	"\x1bMEMBERSHIP_ROLE_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15MEMBERSHIP_ROLE_VOTER\x10\x01\x12\x1b\n" +
	"\x17MEMBERSHIP_ROLE_LEARNER\x10\x02BIZGgithub.com/petabytecl/scrap/internal/gen/scrap/metastore/v1;metastorev1b\x06proto3"
...
var file_scrap_metastore_v1_metastore_proto_goTypes = []any{
	...
	(MembershipRole)(0),                    // 2: scrap.metastore.v1.MembershipRole
	(*DocumentRecord)(nil),                 // 3: scrap.metastore.v1.DocumentRecord
	(*Location)(nil),                       // 4: scrap.metastore.v1.Location
	(*FrameRecord)(nil),                    // 5: scrap.metastore.v1.FrameRecord
	(*ReplicaRef)(nil),                     // 6: scrap.metastore.v1.ReplicaRef
	(*EnvelopeRef)(nil),                    // 7: scrap.metastore.v1.EnvelopeRef
